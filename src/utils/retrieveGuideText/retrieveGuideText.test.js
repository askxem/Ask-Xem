...
describe('retrieveGuideText behaves as expected per deck category', () => {
  ...
  it('returns a rat specific example', async () => {
    ...
    const expected =
      'My friend rat has been deadnamed. We try not to deadname our friends!'
  ...
  it('returns a paragraph of examples from the pronouns api.', async () => {
    ...
    const expected =
      'I think she is very nice. I asked her if I can borrow her pencil. She told me that the house is hers. She said she would rather do it herself.'
